...
const FormControl = ({
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({
    className: (0, _classnames.default)(styles['form-control'], styles[`form-control_${size}`], withFloatLabel && styles[`form-control_withLabel_${size}`], block && styles['form-control_block'], disabled && styles['form-control_disabled'], invalid && styles['form-control_invalid'], className),
    onClick: onClick
    ...
    className: (0, _classnames.default)(styles['form-control__infix'], withFloatLabel && styles['form-control__infix_withLabel'])
  }, withFloatLabel && /*#__PURE__*/_react.default.createElement("label", {
    className: (0, _classnames.default)(styles['form-control__label'], isLabelFloated && styles['form-control__label_floated']),
    htmlFor: labelFor
  }, label), children), trailing && /*#__PURE__*/_react.default.createElement("div", {
